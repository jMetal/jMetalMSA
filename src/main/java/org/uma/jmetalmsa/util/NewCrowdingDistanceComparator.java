 ...
 */
public class NewCrowdingDistanceComparator<S extends Solution<?>> implements Comparator<S>, Serializable {
  private final NewCrowdingDistance<S> NewcrowdingDistance = new NewCrowdingDistance<S>() ;
